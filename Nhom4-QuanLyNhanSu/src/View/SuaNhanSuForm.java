...
public class SuaNhanSuForm extends javax.swing.JDialog {
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatActionPerformed
        ...
        if (isOk) {
            NhanSu nhanSu = new NhanSu(hoTen, diaChi, sdt, trinhDo);
            nhanSu.setMaNhanSu(Integer.parseInt(txtMaNS.getText()));
            trangChu.suaNhanSu(nhanSu);
